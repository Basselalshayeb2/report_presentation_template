...
\begin{frame}{Постановка задачи и данные}
  \begin{itemize}
    \item Постановка задачи: изучение зависимости между признаками и целевой переменной в медицине.
    \item Данные: набор данных из 442 наблюдений и 10 признаков из sklearn.datasets.load_diabetes().
  \end{itemize}
\end{frame}
...
% ================================ СЛАЙД: Установка и запуск среды ================================
\begin{frame}[fragile]{Установка и запуск среды}
  \textbf{Установка:}
...
\begin{frame}{Ковариация и корреляция (Пирсон)}
  ...
  \textbf{Свойства:}
  \begin{itemize}
    \item Инвариантен к сдвигу и масштабу
    \item $\rho = \pm 1 \Leftrightarrow Y = \beta_0 + \beta_1 X$
  \end{itemize}
  \textbf{Корреляция:} сила линейной связи (не причинность).
\end{frame}
