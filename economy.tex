...
\begin{frame}{Проблема}
  \begin{itemize}
    ...
    \item сложные PFM-приложения ориентированы на взрослых пользователей
  \end{itemize}
...
\begin{frame}{Решение: MyBudget}
  ...
  \begin{itemize}
    ...
    \item даёт советы по правилу 50/30/20 и контролю подписок
  \end{itemize}
...
\begin{frame}{Целевая аудитория}
  \begin{itemize}
    ...
    \item \textbf{Цель}: контроль расходов и управление накоплениями на краткосрочные цели
  \end{itemize}
\end{frame}
...
\begin{frame}{Анализ конкурентов}
  \begin{tabularx}{\linewidth}{@{} l X X @{}}
    ...
    \midrule
      CoinKeeper & Яркая визуализация, гибкие категории & Нет простых советов \\
      ...
      MyBudget & Студент-центричность, простые советы & \textbf{—} \\
    \bottomrule
  \end{tabularx}
...
\begin{frame}{Маркетинг-план (6 месяцев)}
  ...
  \begin{enumerate}
    ...
    \item \textbf{Партнёрства (4–6 мес)}: студенческие сообщества.
    \item \textbf{Рефералы}: бонусы за приглашения.
    \item \textbf{Удержание}: еженедельные челленджи, push-уведомления, внутренняя геймификация.
  \end{enumerate}
  \vspace{0.3em}
  \textbf{KPI:} 15k установок, 30\% удержание.
  \column{0.4\textwidth}
...
\begin{frame}{Прибыльность}
  \begin{itemize}
    \item \textbf{Реклама}: ненавязчивые баннеры и партнёрские предложения.
    \item \textbf{Реклама за вознаграждение}: просмотр короткой рекламы для разблокировки расширенной аналитики на 24 часа.
    \item \textbf{Партнёрства}: банки, программы лояльности для студентов.
    \end{itemize}
  \vspace{0.6em}
  \begin{tabular}{@{} l r @{}}
  \toprule
  Пользователи через 1 год & 20,000 \\
  Средний доход на пользователя (eCPM \~ 2 {\footnotesize \faRub}/день) & 60 {\footnotesize \faRub}/мес \\
  Месячный доход от рекламы & 1.2 млн {\footnotesize \faRub} \\
  Расходы (серверы, маркетинг, команда) & 400k {\footnotesize \faRub}/мес \\
  Месячная прибыль & 800k {\footnotesize \faRub}/мес \\
  \textbf{Годовая прибыль} & \textbf{\~9,6 млн {\footnotesize \faRub}} \\
  \bottomrule
  \end{tabular}
...
\begin{frame}{Команда}
  ...
  Кисельков Денис Андреевич & Мобильная разработка & Flutter / React Native \\
  \bottomrule
  \end{tabularx}
\end{frame}
...
\begin{frame}{Риски и меры}
  \begin{itemize}
    \item \textbf{Удержание}: пользователи перестают вносить траты → напоминания, геймификация.
    \item \textbf{Конкуренция}: фокус на студента.
...
\end{frame}
  ...
  % ---------------- Closing ----------------
\begin{frame}{Итог}
  MyBudget — помощник, который говорит со студентом на одном языке: \\
  \alert{просто, понятно и экономит деньги.}
  \vspace{1em}
  Спасибо за внимание!
\end{frame}
